...
<head>
    ...
    <title>Accountant Forgot Password | EduAdmit Pro</title>
    <!-- Bootstrap -->
        ...
        <div class="row h-100">
            ...
            <div class="col-md-6 right-panel">
                <div class="login-box">
                    ...
                    <div class="muted mb-4" id="formSubtitle">Enter your email to receive reset instructions
                    </div>
                    ...
                    {{-- Form --}}
                    <form id="signinForm" action="{{ route('accountant.password.email') }}" method="POST">
                        @csrf
                        <div class="mb-4">
