...
<head>
    <meta charset="UTF-8">
    <title>Counselytics Portal - Forgot Password</title>
            ...
            <div class="col-12 d-flex justify-content-center">
                <div class="login-wrapper">
                    <div class="login-left">
                        ...
                        @if (session('success'))
                            <div
                                class="alert alert-success border border-success border-opacity-25 bg-success bg-opacity-10 text-success small rounded-3 fw-medium">
                        ...
                        <form action="{{ route('counselor.password.email') }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label class="form-label">Email Address</label>
                                <input type="email" name="email" class="form-control" required autofocus>
                            </div>
                            <button class="btn btn-login shadow-sm mb-3">Send Reset Link</button>
                            <div class="text-center">
                                <a href="{{ route('counselor.login') }}" class="text-success text-decoration-none small" style="font-weight: 600;"><i class="fa fa-arrow-left me-1"></i> Back to Login</a>
                            </div>
                        </form>
                    </div>
